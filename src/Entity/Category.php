...
class Category extends Database
{
    ...
    {
        $insert = 'INSERT INTO `category_article` (`title`, `description`) VALUES (:title, :description);';
    ...
    {
        $query = 'SELECT * FROM `category_article`';
    ...
    {
        $requete = 'SELECT * FROM `category_article` WHERE `id`=:id ;';
    ...
    {
        $query = 'UPDATE `category_article` SET  `title`=:title, `description`=:description  WHERE `id`=:id;';
    ...
    {
        $query = 'DELETE FROM `category_article` WHERE `id`=:id;';
